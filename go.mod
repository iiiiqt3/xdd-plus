...
replace github.com/Mrs4s/go-cqhttp v1.0.0-beta8-fix2 => github.com/764763903a/go-cqhttp v1.1.9

//replace github.com/Mrs4s/go-cqhttp v1.0.0-beta8-fix2 => github.com/Mrs4s/go-cqhttp v1.0.0-rc3
...
require (
	...
	github.com/tinyhubs/tinydom v0.0.0-20200514151848-c8d6fb49f183 // indirect
