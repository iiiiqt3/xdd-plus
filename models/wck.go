...
//	data, _ := httplib.Post("https://sign.smxy.xyz/jd/genToken").Header("Authorization", "Bearer "+Config.WsToken).Header("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8").Bytes()
...
func getZooToken() string {
	data, _ := httplib.Post("https://sign.smxy.xyz/jd/sign").Body("body={}&functionId=genToken").Bytes()
	getString, _ := jsonparser.GetString(data, "data", "convertUrl")
	return getString
}
