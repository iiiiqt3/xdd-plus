...
func GetUUID() string {
	//uuidArray := [11]string{
	//   0000000000000629A23A64A2E4827899D5CF37CAF5CDDA169229166403527443547
	...
	//	"000000000000026CD052477C44C26964557ABBE7B24C7A168980721534295742"}
	rand.Seed(time.Now().UnixNano())
	uuid := fmt.Sprintf("0000000000000%sA%d%d", strings.ReplaceAll(strings.ToUpper(uuid.New().String()), "-", ""), time.Now().UnixMilli(), rand.Intn(89)+10)
	return uuid
}
