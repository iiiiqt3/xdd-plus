...
func GetQRCODEMac(Data GetQRReq) models.ResponseResult2 {
	...
	if D == nil || D.Wxid == "" || D.ClientVersion != Algorithm.MacVersion {
		// 没有缓存, 初始化新的账号环境
		D = GenMacLoginData(reqDataLogin)
	} else {
		D = UpdateMacLoginData(D, reqDataLogin)
	}
