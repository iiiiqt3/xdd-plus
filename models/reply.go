...
func SendWxMsg(uid string, msg string) {
	...
	case "qx":
		...
		Info(Config.Wx.Url + "/DaenWxHook/httpapi/?wxid=" + Config.Wx.Robotid)
		Info(Config.Wx.Robotid)
